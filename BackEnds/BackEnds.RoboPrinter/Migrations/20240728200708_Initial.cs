    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OperativeModes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppSettings_DataTypes_DataTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RobotPoints", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RobotPoints_PointTypes_PointTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OperativeModeId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Histories_OperativeModes_OperativeModeId",
                        column: x => x.OperativeModeId,
                        principalTable: "OperativeModes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RobotPointId = table.Column<int>(type: "int", nullable: false),
                    StepOrder = table.Column<int>(type: "int", nullable: false),
                    Speed = table.Column<int>(type: "int", nullable: false),
                    ClearZone = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RouteSteps", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RouteSteps_RobotPoints_RobotPointId",
                        column: x => x.RobotPointId,
                        principalTable: "RobotPoints",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppSettings_DataTypeId",
                table: "AppSettings",
                column: "DataTypeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Histories_OperativeModeId",
                table: "Histories",
                column: "OperativeModeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RobotPoints_PointTypeId",
                table: "RobotPoints",
                column: "PointTypeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RouteSteps_RobotPointId",
                table: "RouteSteps",
                column: "RobotPointId");
